...
export default function CustomerSatisfication() {
  return (
    <section className="flex h-full flex-col gap-2">
      <ChartTitle title="Avaliaçôes dos clientes" icon={SmilePlus} />
...
function TotalCustomers() {
  return (
    <div className="flex flex-col items-start justify-center">
      <div className="text-xs text-muted-foreground">Fedback recebidos</div>
      <div className="text-2xl font-medium">{totalCustomers} Avaliações</div>
    </div>
  );
}
