...
const conductivityData = [
  { time: "t1", conductivity: 65, material: "TNT" },
  { time: "t2", conductivity: 60, material: "TNT" },
  { time: "t3", conductivity: 56, material: "TNT" },
  { time: "t4", conductivity: 53, material: "TNT" },

  { time: "t1", conductivity: 65, material: "Controle" },
  { time: "t2", conductivity: 57, material: "Controle" },
  { time: "t3", conductivity: 52, material: "Controle" },
  { time: "t4", conductivity: 47, material: "Controle" },
];
...
export default function ConductivityChartBlock() {
  ...
  const avgAluminio = useMemo(
    () => calcAverageConductivity(conductivityData, "TNT"),
    []
  );
  ...
  return (
    <section className="flex h-full flex-col gap-2">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <ChartTitle
          title="Condutividade Térmica — TNT x Controle"
          icon={Thermometer}
        />
      </div>
