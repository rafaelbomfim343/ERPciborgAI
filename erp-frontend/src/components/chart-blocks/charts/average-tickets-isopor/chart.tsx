...
const conductivityData = [
  { time: "5 min", conductivity: 53, material: "Isopor" },
  { time: "10 min", conductivity: 48, material: "Isopor" },
  { time: "15 min", conductivity: 45, material: "Isopor" },
  { time: "20 min", conductivity: 42, material: "Isopor" },
