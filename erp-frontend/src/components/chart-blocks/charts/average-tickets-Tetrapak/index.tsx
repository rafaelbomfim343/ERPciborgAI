...
const conductivityData = [
  { time: "t1", conductivity: 52, material: "Tetrapak" },
  { time: "t2", conductivity: 47, material: "Tetrapak" },
  { time: "t3", conductivity: 44, material: "Tetrapak" },
  { time: "t4", conductivity: 42, material: "Tetrapak" },
...
export default function ConductivityChartBlock() {
  ...
  const avgAluminio = useMemo(
    () => calcAverageConductivity(conductivityData, "Tetrapak"),
    []
  );
  ...
  return (
    <section className="flex h-full flex-col gap-2">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <ChartTitle
          title="Condutividade Térmica — Tetrapak x Controle"
          icon={Thermometer}
        />
      </div>
