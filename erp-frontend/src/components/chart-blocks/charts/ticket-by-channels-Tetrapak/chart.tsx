...
import { ticketByChannelsTetrapak } from "@/data/ticket-by-channels";
import { addThousandsSeparator } from "@/lib/utils";

const data = ticketByChannelsTetrapak.reduce(
  (acc, curr) => {
    acc.push({
      type: curr.type,
...
const spec: IPieChartSpec = {
  ...
  data: [
    {
      id: "id0",
      values: ticketByChannelsTetrapak,
    },
  ],
  valueField: "value",
  categoryField: "type",
